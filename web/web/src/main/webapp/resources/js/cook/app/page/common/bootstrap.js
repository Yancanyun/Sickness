        ...
        Tooltip.prototype.show = function() {
            ...
            if (this.hasContent() && this.enabled) {
                ...
                if (autoPlace) {
                    ...
                    var parentLeft = this.options.container == 'body' ? 0 : $parent.offset()
                        .left
    ...
    + function($) {
        ...
        function ScrollSpy(element, options) {
            ...
            this.selector = (this.options.target || ((href = $(element)
                    .attr('href')) && href.replace(/.*(?=#[^\s]+$)/, '')) //strip for ie7
                || '') + ' .nav li > a'
            this.offsets = $([])
            this.targets = $([])
            ...
            var $targets = this.$body
                ...
                .map(function() {
                    ...
                    return ($href && $href.length && [
                        [$href[offsetMethod]()
                            .top + (!$.isWindow(self.$scrollElement.get(0)) && self.$scrollElement.scrollTop()), href
                        ]
                    ]) || null
                })
                .sort(function(a, b) {
