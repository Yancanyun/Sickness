...
<script type="text/template" id="dishTpl">
  ...
  <li class="dish clearfix"  data-dish-id="&{it.dishId}">
    <a href="#" class="dish-img"><img class="lazy-load" src="${staticWebsite}img/mobile/common/default-img.png" data-original="&{it.src}" data-lazy-container=".dish-list" alt="菜品图片"></a>
