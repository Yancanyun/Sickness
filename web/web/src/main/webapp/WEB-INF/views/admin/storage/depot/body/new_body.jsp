...
<div class="row">
    ...
    <div class="col-sm-12">
        <form class="form-horizontal J_submitForm" action="${website}admin/storage/depot/new" method="post">
            <c:if test="${!empty msg}">
            ...
            <div class="panel panel-info">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control" rows="3" data-valid-tip="请输入长度为0~20个字符的简介|输入有误，请重新输入" data-valid-rule="isNull|length(0,21)" name="introduction" value=""></textarea>
                        </div>
                    </div>
                </div>
