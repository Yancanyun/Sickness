...
<tiles:insertDefinition name="admin">
    ...
    <tiles:putAttribute name="body" value="/WEB-INF/views/admin/dish/card/body/list_cost_card_body.jsp"/>
    <tiles:putAttribute name="script" value="/WEB-INF/views/admin/dish/card/inc/list_cost_card_script.jsp"/>
