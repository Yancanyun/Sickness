                ...
                <div class="panel panel-info">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="storageQuantity" class="w180" data-valid-rule="isFloat" data-valid-tip="请输入库存量|输入有误，请重新填写" placeholder="请输入库存量">
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select class="w180 form-control" name="costCardUnitId">
                                    <c:if test="${fn:length(costCardUnits) == 0}">
                                        <option value="" selected>无</option>
                                    </c:if>
                                    <c:if test="${fn:length(costCardUnits) > 0}">
                                        <c:forEach var="costCardUnit" items="${costCardUnits}">
                                            <option value="${costCardUnit.id}">${costCardUnit.name}</option>
                                        </c:forEach>
                                    </c:if>
                                </select>
                            </div>
