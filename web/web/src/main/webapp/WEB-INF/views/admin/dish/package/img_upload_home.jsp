...
<tiles:insertDefinition name="admin">
    ...
    <tiles:putAttribute name="body" value="/WEB-INF/views/admin/dish/package/body/img_upload_body.jsp"/>
    <tiles:putAttribute name="script" value="/WEB-INF/views/admin/dish/package/inc/img_upload_script.jsp"/>
