          ...
          <div class="panel-body">
            <form class="form-horizontal J_searchForm col-sm-offset-1">
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  <input type="text" class="J_startTime w180 date" data-start-time="${firstToday}" readonly="readonly" name="startTime" value="${firstToday}" />
                  <span class="to">~</span>
                  <input type="text" class="J_endTime w180 date" data-end-time="${lastToday}" readonly="readonly" name="endTime" value="${lastToday}" />
                </div>
              </div>
              <div class="form-group " >
        ...
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <div class="text-right">
              <a href="${website}admin/revenue/checkout/exportToExcel" class="btn btn-warning margin-bottom-15 J_export"><i class="fa fa-download"></i>&nbsp;导出Excel</a>
            </div>
