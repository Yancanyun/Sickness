      ...
      <div class="panel-body">
        <form class="form-horizontal J_gradeForm" method="post" action="${website}admin/vip/grade/update/${vipGrade.id}" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <input class="w180" type="text" name="settlementCycle" value="${vipGrade.settlementCycle}" data-valid-tip="请输入结算周期|结算周期不符合规格，请重新输入" data-valid-rule="notNegativeNumber"/>&nbsp;月
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-3 control-label">
