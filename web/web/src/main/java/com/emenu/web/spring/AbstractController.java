...
public class AbstractController extends Base {
    ...
    //厨房管理
    @StaticAutoWire
    @Qualifier("stockKitchenService")
    protected static StockKitchenService stockKitchenService;
    ...
    //物品管理
    @StaticAutoWire
    @Qualifier("stockWarnService")
    protected  static StockWarnService stockWarnService;
}
