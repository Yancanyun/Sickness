...
public final class URLConstants {
    ...
    //餐台区域管理页面
    public static final String AREA_URL = "admin/area";

    //餐台管理页面
    public static final String TABLE_URL = "admin/table";

    //餐台二维码管理页面
    public static final String QRCODE_URL = "admin/qrcode";

    //点餐平台首页图片管理url
    public static final String INDEX_IMG_URL = "admin/index/img";

    //会员基本信息管理
    public static final String VIP_VIPINFO_URL = "admin/party/vip";
