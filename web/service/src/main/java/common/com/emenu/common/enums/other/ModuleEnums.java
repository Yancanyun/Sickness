...
public enum ModuleEnums {
    ...
    // 退菜清单
    AdminCountBackDishList("Admin:Revenue:Count:BackDish"),

    // 营业分析
    AdminCountDishSaleRanking("Admin:Rank:Count"),
    // 统计菜品销售排行
    AdminCountDishSaleRankingList("Admin:Rank:Count:SaleRanking"),
    //统计菜品大类销售排行
    AdminCountDishTagRankingList("Admin:Rank:Count:TagRanking"),
    ...
    AdminStockKitchenItemList("Admin:Stock:KitchenItem:List"),

    //新版库存分类管理
    AdminStockTag("Admin:Stock:Tag"),
    AdminStockTagList("Admin:Stock:Tag:List"),
    AdminStockTagNew("Admin:Stock:Tag:New"),
    AdminStockTagUpdate("Admin:Stock:Tag:Update"),
    AdminStockTagDelete("Admin:Stock:Tag:Delete"),
    ...
    VarVipRecharge("Bar:Vip:Recharge"),
    VarVipRechargeConfirm("Bar:Vip:Recharge:Confirm"),
